...
- `manifest_version: 2` est utilisé (legacy selon les navigateurs) : selon la politique du navigateur, l’extension peut nécessiter une migration vers Manifest V3 à terme.
- La copie repose sur `document.execCommand('copy')`, API historique.
